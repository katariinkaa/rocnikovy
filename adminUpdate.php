...
if (count($_POST) > 0) {
    mysqli_query($connect, "UPDATE users set user_id='" . $_POST['user_id'] . "', user_name='" . $_POST['user_name'] . "', user_email='" . $_POST['user_email'] . "', user_tokens='" . $_POST['user_tokens'] . "' ,user_roles='" . $_POST['user_roles'] . "' 
